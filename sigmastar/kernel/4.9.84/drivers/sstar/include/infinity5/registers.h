...
#define IMI_PHYS                0x1FC00000
#define IMI_VIRT                (IMI_PHYS+IMI_OFFSET) //from IO_ADDRESS(x)
#define IMI_OFFSET              (MS_IO_OFFSET)
#define IMI_SIZE                0x20000
...
#define BASE_REG_PMSLEEP_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x000E00)
#define BASE_REG_PMGPIO_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x000F00)
#define BASE_REG_PMRTC_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x001200)
#define BASE_REG_PMSAR_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x001400)
#define BASE_REG_PMTOP_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x001E00)
#define BASE_REG_INTRCTL_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100900)
#define BASE_REG_DIDKEY_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x003800)
#define BASE_REG_MIU_PA         GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101200)
#define BASE_REG_MIU1_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100D00)
#define BASE_REG_MIU1_ARB_B_PA  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100F00)
#define BASE_REG_MIU_ARB_B_PA   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101400)
#define BASE_REG_MIU_ARB_E_PA   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101600)
#define BASE_REG_MIU1_ARB_E_PA  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101900)
...
#define BASE_REG_MCM_SC_GP2_PA  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x113600)
...
#define BASE_REG_EFUSE_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x002000)
#define BASE_REG_MAILBOX_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100400)
#define BASE_REG_MOVDMA_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x131B00)
...
typedef enum
{
    MS_I5_PACKAGE_UNKNOWN =0x00,
    MS_I5_PACKAGE_BGA_13X13,
    MS_I5_PACKAGE_QFN,
    MS_I5_PACKAGE_EXTENDED=0x30,
    MS_I5_PACKAGE_FPGA_128MB =0x90,
} MS_I5_PACKAGE_TYPE;
