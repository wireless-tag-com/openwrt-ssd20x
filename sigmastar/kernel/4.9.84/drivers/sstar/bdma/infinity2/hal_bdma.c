...
static bool m_bBdmaFree[HAL_BDMA_CH_NUM] = {TRUE, TRUE};
static HalBdmaTxCb m_pfBdmaTxDoneCBFunc[HAL_BDMA_CH_NUM] = {NULL, NULL};
static bool m_bBdmaInited[HAL_BDMA_CH_NUM] = {0, 0};
...
HalBdmaErr_e HalBdma_Transfer(u8 u8DmaCh, HalBdmaParam_t *ptBdmaParam)
{
    ...
    switch(ptBdmaParam->ePathSel)
    {
        case HAL_BDMA_MIU0_TO_MIU0:
            ...
            g_ptKeBdma->reg_ch0_replace_miu = 0x0;
...
//    g_ptKeBdma->reg_ch0_src_dw  = ptBdmaParam->eSrcDataWidth;
//    g_ptKeBdma->reg_ch0_dst_dw  = ptBdmaParam->eDstDataWidth;
