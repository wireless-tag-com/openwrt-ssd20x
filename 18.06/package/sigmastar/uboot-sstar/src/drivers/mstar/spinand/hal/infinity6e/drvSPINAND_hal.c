...
U32 HAL_SPINAND_Init(void)
{
    ...
    switch(u8BoundID)
    {
        case CHIP_BOUND_QFN88:
            _hal_fsp.u32FspBaseAddr = RIU_PM_BASE + BK_PM_FSP;
            _hal_fsp.u32QspiBaseAddr = RIU_PM_BASE + BK_PM_QSPI;
            break;
        default:
            _hal_fsp.u32FspBaseAddr = RIU_BASE + BK_FSP;
            _hal_fsp.u32QspiBaseAddr = RIU_BASE + BK_QSPI;
            break;
    }
