   ...
   //MS_U8   u8Status0, u8Status1;
    ...
    if (HAL_SERFLASH_ReadID(u8FlashId, sizeof(u8FlashId))== TRUE)
    {
       ...
       // printf("[%x]\n",_hal_SERFLASH.u16FlashType);
        ...
        {
            if((_hal_SERFLASH.u8MID == MID_MXIC)||(_hal_SERFLASH.u8MID == MID_WB)||(_hal_SERFLASH.u8MID == MID_GD))
            {
...
#ifdef CONFIG_NOR_DUAL_AD_READ
    gReadMode = E_DUAL_AD_MODE;
#elif defined CONFIG_NOR_QUAD_AD_READ
    gReadMode = E_QUAD_MODE;
#else
