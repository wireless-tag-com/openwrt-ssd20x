...
#define INT_IRQ_DUMMY_00          (GIC_SPI_MS_IRQ_START +  0)
#define INT_IRQ_DUMMY_01          (GIC_SPI_MS_IRQ_START +  1)
#define INT_IRQ_DUMMY_02          (GIC_SPI_MS_IRQ_START +  2)
#define INT_IRQ_DUMMY_03          (GIC_SPI_MS_IRQ_START +  3)
#define INT_IRQ_DUMMY_04          (GIC_SPI_MS_IRQ_START +  4)
#define INT_IRQ_MHE               (GIC_SPI_MS_IRQ_START +  5) //I5 New
#define INT_IRQ_DUMMY_06          (GIC_SPI_MS_IRQ_START +  6)
#define INT_IRQ_DIP               (GIC_SPI_MS_IRQ_START +  7) //I5 New
#define INT_IRQ_DUMMY_08          (GIC_SPI_MS_IRQ_START +  8)
#define INT_IRQ_BDMA_2            (GIC_SPI_MS_IRQ_START +  9) //I5 New
#define INT_IRQ_BDMA_3            (GIC_SPI_MS_IRQ_START + 10) //I5 New
#define INT_IRQ_MIIC_2            (GIC_SPI_MS_IRQ_START + 11) //I5 New
#define INT_IRQ_MIIC_3            (GIC_SPI_MS_IRQ_START + 12) //I5 New
#define INT_IRQ_LDC_FEYE          (GIC_SPI_MS_IRQ_START + 13) //I5 New
#define INT_IRQ_DUMMY_14          (GIC_SPI_MS_IRQ_START + 14)
#define INT_IRQ_PM_SLEEP          (GIC_SPI_MS_IRQ_START + 15)
...
#define INT_IRQ_DUMMY_21          (GIC_SPI_MS_IRQ_START + 21)
...
#define INT_IRQ_MIPI_CSI2_0       (GIC_SPI_MS_IRQ_START + 33)
...
#define INT_IRQ_IVE_INT           (GIC_SPI_MS_IRQ_START + 56)
#define INT_IRQ_DLA_IRQ           (GIC_SPI_MS_IRQ_START + 57) //I5 New
#define INT_IRQ_SC1_TOP_INT       (GIC_SPI_MS_IRQ_START + 58)
#define INT_IRQ_SC2_TOP_INT       (GIC_SPI_MS_IRQ_START + 59)
#define INT_IRQ_MIPI_CSI2_1       (GIC_SPI_MS_IRQ_START + 60)
#define INT_IRQ_VIF               (GIC_SPI_MS_IRQ_START + 61) //I5 New
#define INT_IRQ_MOVEDMA           (GIC_SPI_MS_IRQ_START + 62) //I5 New
#define INT_IRQ_CMDQ3             (GIC_SPI_MS_IRQ_START + 63) //I5 New
