/*
* ETH_TX_100T_RANDOM.h- Sigmastar
*
...
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003240), 0x30);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003187), 0x14);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x0000312d), 0x0c);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003101), 0xa1);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003101), 0x21);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003101), 0x21);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003101), 0x21);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003187), 0x14);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x000032d5), 0x80);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x0000325a), 0x00);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x0000325b), 0xc0);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x00003253), 0x4f);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x0000315d), 0x06);
OUTREG8(GET_REG8_ADDRE(RIU_BASE_ADDR, 0x0000315d), 0x02);
// measure  RJ45 connector
