...
#define BASE_REG_EFUSE_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103340)
...
#define BASE_REG_MOVDMA_PA               GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x112500)
#define BASE_REG_BDMA0_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100900)
#define BASE_REG_BDMA1_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100920)
