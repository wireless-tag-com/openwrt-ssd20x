...
int MHal_EMAC_write_phy(void*, unsigned char phy_addr, unsigned char address, u32 value);
int MHal_EMAC_read_phy(void*, unsigned char phy_addr, unsigned char address,u32 *value);
