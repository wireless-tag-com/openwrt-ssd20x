...
#define    REG_CKG_BIST_IPU_GP_BASE   (REG_CKG_BASE+0x03*4)
#define    REG_CKG_BIST_IPU_GP_OFFSET (12)
...
#define    REG_CKG_CSI_MAC_LPTX_TOP0_BASE   (REG_CKG_BASE+0x53*4)
#define    REG_CKG_CSI_MAC_LPTX_TOP0_OFFSET (0)

#define    REG_CKG_CSI_MAC_LPTX_TOP1_BASE   (REG_CKG_BASE+0x54*4)
#define    REG_CKG_CSI_MAC_LPTX_TOP1_OFFSET (8)

#define    REG_CKG_CSI_MAC_TOP0_BASE   (REG_CKG_BASE+0x53*4)
#define    REG_CKG_CSI_MAC_TOP0_OFFSET (8)

#define    REG_CKG_CSI_MAC_TOP1_BASE   (REG_CKG_BASE+0x55*4)
#define    REG_CKG_CSI_MAC_TOP1_OFFSET (0)
...
#define    REG_CKG_ISPSC_LDC_FEYE_BASE   (REG_CKG_BASE+0x65*4)
...
#define    REG_CKG_MIIC2_BASE   (REG_CKG_BASE+0x38*4)
#define    REG_CKG_MIIC2_OFFSET (0)

#define    REG_CKG_MIIC3_BASE   (REG_CKG_BASE+0x38*4)
#define    REG_CKG_MIIC3_OFFSET (8)
...
#define    REG_CKG_NS_TOP0_BASE   (REG_CKG_BASE+0x54*4)
#define    REG_CKG_NS_TOP0_OFFSET (0)

#define    REG_CKG_NS_TOP1_BASE   (REG_CKG_BASE+0x55*4)
#define    REG_CKG_NS_TOP1_OFFSET (8)
...
#define    REG_CKG_SR_MCLK1_BASE   (REG_CKG_BASE+0x56*4)
#define    REG_CKG_SR_MCLK1_OFFSET (0)
