...
static BOOL HAL_HWI2C_DelayClkRelease(U16 u16PortOffset, BOOL bEnable)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C_WriteRegBit(REG_HWI2C_MIIC_RESERVE+u16PortOffset, _DELAY_CLK_RELEASE, bEnable);
}
...
BOOL HAL_HWI2C_Master_Enable(U16 u16PortOffset)
{
    ...
    HAL_HWI2C_DelayClkRelease(u16PortOffset,TRUE);
    #if 0
...
BOOL HAL_HWI2C_SelectPort(HAL_HWI2C_PORT ePort)
{
    ...
    else if(ePort==E_HAL_HWI2C_PORT2_4)
    {
        u8Value1 = CHIP_MIIC2_PAD_4;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT2_5)
    {
        u8Value1 = CHIP_MIIC2_PAD_5;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT2_6)
    {
        u8Value1 = CHIP_MIIC2_PAD_6;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT2_7)
    {
        u8Value1 = CHIP_MIIC2_PAD_7;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    ...
    else if(ePort==E_HAL_HWI2C_PORT3_4)
    {
        u8Value1 = CHIP_MIIC3_PAD_4;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC3, u8Value1, CHIP_MIIC3_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT3_5)
    {
        u8Value1 = CHIP_MIIC3_PAD_5;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC3, u8Value1, CHIP_MIIC3_PAD_MSK);
    }
    else
    {
...
BOOL HAL_HWI2C_SetClk(U16 u16PortOffset, HAL_HWI2C_CLKSEL eClkSel)
{
    ...
    {
        case E_HAL_HWI2C_CLKSEL_HIGH: // 400 KHz
            u16ClkHCnt =  26; u16ClkLCnt =   28; break;
        case E_HAL_HWI2C_CLKSEL_NORMAL: //300 KHz
            u16ClkHCnt =  35; u16ClkLCnt =   37; break;
        case E_HAL_HWI2C_CLKSEL_SLOW: //200 KHz
            u16ClkHCnt =  50; u16ClkLCnt =   64; break;
        case E_HAL_HWI2C_CLKSEL_VSLOW: //100 KHz
            u16ClkHCnt =  113; u16ClkLCnt = 115; break;
        case E_HAL_HWI2C_CLKSEL_USLOW: //50 KHz
            u16ClkHCnt =  232; u16ClkLCnt = 234; break;
        case E_HAL_HWI2C_CLKSEL_UVSLOW: //25 KHz
            u16ClkHCnt =  255; u16ClkLCnt = 255; break;
        default:
            u16ClkHCnt =  35; u16ClkLCnt =  37;  break;
    }
