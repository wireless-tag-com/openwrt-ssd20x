...
#define GPIO38_PAD PAD_SNR0_GPIO2
...
#define GPIO43_IN  0x103c66, BIT0
#define GPIO43_OUT 0x103c66, BIT4

#define GPIO44_PAD PAD_SNR1_DA0N
#define GPIO44_OEN 0x103c76, BIT5
#define GPIO44_IN  0x103c68, BIT0
#define GPIO44_OUT 0x103c68, BIT4

#define GPIO45_PAD PAD_SNR1_CKP
#define GPIO45_OEN 0x103c78, BIT5
#define GPIO45_IN  0x103c6a, BIT0
#define GPIO45_OUT 0x103c6a, BIT4

#define GPIO46_PAD PAD_SNR1_CKN
#define GPIO46_OEN 0x103c7a, BIT5
#define GPIO46_IN  0x103c6c, BIT0
#define GPIO46_OUT 0x103c6c, BIT4

#define GPIO47_PAD PAD_SNR1_DA1P
#define GPIO47_OEN 0x103c7c, BIT5
#define GPIO47_IN  0x103c6e, BIT0
#define GPIO47_OUT 0x103c6e, BIT4

#define GPIO48_PAD PAD_SNR1_DA1N
#define GPIO48_OEN 0x103c7e, BIT5
#define GPIO48_IN  0x103c70, BIT0
#define GPIO48_OUT 0x103c70, BIT4

#define GPIO49_PAD PAD_SNR1_GPIO0
#define GPIO49_OEN 0x103c66, BIT5
#define GPIO49_IN  0x103c72, BIT0
#define GPIO49_OUT 0x103c72, BIT4

#define GPIO50_PAD PAD_SNR1_GPIO1
#define GPIO50_OEN 0x103c68, BIT5
#define GPIO50_IN  0x103c74, BIT0
#define GPIO50_OUT 0x103c74, BIT4

#define GPIO51_PAD PAD_SNR1_GPIO2
#define GPIO51_OEN 0x103c6a, BIT5
#define GPIO51_IN  0x103c76, BIT0
#define GPIO51_OUT 0x103c76, BIT4

#define GPIO52_PAD PAD_SNR1_GPIO3
#define GPIO52_OEN 0x103c6c, BIT5
#define GPIO52_IN  0x103c78, BIT0
#define GPIO52_OUT 0x103c78, BIT4

#define GPIO53_PAD PAD_SNR1_GPIO4
#define GPIO53_OEN 0x103c6e, BIT5
#define GPIO53_IN  0x103c7a, BIT0
#define GPIO53_OUT 0x103c7a, BIT4

#define GPIO54_PAD PAD_SNR1_GPIO5
#define GPIO54_OEN 0x103c70, BIT5
#define GPIO54_IN  0x103c7c, BIT0
#define GPIO54_OUT 0x103c7c, BIT4

#define GPIO55_PAD PAD_SNR1_GPIO6
#define GPIO55_OEN 0x103c72, BIT5
#define GPIO55_IN  0x103c7e, BIT0
#define GPIO55_OUT 0x103c7e, BIT4

#define GPIO56_PAD PAD_NAND_ALE
#define GPIO56_OEN 0x103c82, BIT5
#define GPIO56_IN  0x103c82, BIT0
#define GPIO56_OUT 0x103c82, BIT4

#define GPIO57_PAD PAD_NAND_CLE
#define GPIO57_OEN 0x103c84, BIT5
#define GPIO57_IN  0x103c84, BIT0
#define GPIO57_OUT 0x103c84, BIT4

#define GPIO58_PAD PAD_NAND_CEZ
#define GPIO58_OEN 0x103c80, BIT5
#define GPIO58_IN  0x103c80, BIT0
#define GPIO58_OUT 0x103c80, BIT4
...
void MHal_FuartPAD_DisableFunction(U8 u8IndexGPIO)
{
    ...
    else if (PAD_FUART_RTS != u8IndexGPIO) {
...
void MHal_GPIO_Pad_Set(U8 u8IndexGPIO)
{
    ...
    case PAD_FUART_RX:
        ...
        MHal_FuartPAD_DisableFunction(u8IndexGPIO);
        break;
    case PAD_FUART_TX:
...
static int PMSLEEP_GPIO_To_Irq(U8 u8IndexGPIO)
{
    if (u8IndexGPIO == PAD_PM_IRIN)
        return INT_PMSLEEP_IRIN;
    else if (u8IndexGPIO >= PAD_PM_GPIO0 && u8IndexGPIO <= PAD_PM_GPIO15)
        return (u8IndexGPIO-PAD_PM_GPIO0) + INT_PMSLEEP_GPIO_0;
    else
        return -1;
}
