...
#define CHIP_REG_HWI2C_MIIC2            (CHIP_REG_BASE+ (0x06*2))
    ...
    #define CHIP_MIIC2_PAD_5            (__BIT7|__BIT5)
    #define CHIP_MIIC2_PAD_6            (__BIT7|__BIT6)
    #define CHIP_MIIC2_PAD_7            (__BIT5|__BIT6|__BIT7)
    #define CHIP_MIIC2_PAD_MSK          (__BIT5|__BIT6|__BIT7)

//for port 3
#define CHIP_REG_HWI2C_MIIC3            (CHIP_REG_BASE+ (0x06*2)+0x1) //high byte address
    ...
    #define CHIP_MIIC3_PAD_5            (__BIT2|__BIT0)
    #define CHIP_MIIC3_PAD_MSK          (__BIT0|__BIT1|__BIT2)

//for port 4
#define CHIP_REG_HWI2C_MIIC4            (CHIP_REG_BASE+ (0x06*2)+0x1)//high byte address
    #define CHIP_MIIC4_PAD_0            (0)
    #define CHIP_MIIC4_PAD_1            (__BIT3)
    #define CHIP_MIIC4_PAD_2            (__BIT4)
    #define CHIP_MIIC4_PAD_3            (__BIT3|__BIT4)
    #define CHIP_MIIC4_PAD_MSK          (__BIT3|__BIT4)
...
#define REG_HWI2C_MIIC_RESERVE              (HWI2C_REG_BASE+0x10*2)
        #define _DELAY_CLK_RELEASE                (__BIT6)
//DMA mode
